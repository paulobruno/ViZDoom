...
# game.load_config("../../scenarios/health_poison.cfg")
...
# PB: test a custom wad
#game.set_doom_scenario_path("../../scenarios/health_poison.wad")
#game.set_doom_scenario_path("../../scenarios/health_poison_rewards.wad")
#game.load_config("../../scenarios/health_poison.cfg")
#game.load_config("../../scenarios/health_poison_rewards.cfg")
#game.load_config("../../scenarios/health_poison_rewards_floor.cfg")
game.load_config("../../scenarios/new_death.cfg")
